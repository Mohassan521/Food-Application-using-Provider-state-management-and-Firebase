...
class DrinksDetailsPage extends StatefulWidget {

  final String image;
  final String name;
  final int price;

  const DrinksDetailsPage({super.key ,required this.image, required this.name, required this.price});

  @override
  State<DrinksDetailsPage> createState() => _DrinksDetailsPageState();
}

class _DrinksDetailsPageState extends State<DrinksDetailsPage> {
  int quantity = 1;
  @override
